...
export default function CreateTour() {
  ...
  const fillSampleData = () => {
    setFormData({
      ...
      description:
        "A remote virtual visit to the Kigali Genocide Memorial, allowing people worldwide to pay their respects and learn about the 1994 Rwandan Genocide against the Tutsi.",
    ...
    setHotspots(SAMPLE_HOTSPOTS);
    setAudioRegions(SAMPLE_AUDIO_REGIONS);
    setEffects(SAMPLE_EFFECTS);
    setStep(2);
  };
