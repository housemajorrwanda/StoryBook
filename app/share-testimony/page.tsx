  ...
  return (
    <PageLayout showBackgroundEffects={true} variant="default">
      <div className="min-h-screen bg-gray-50">
        ...
        {/* Header Navigation */}
        <header className="bg-white border-b mt-10 border-gray-200 sticky top-0 z-10">
        ...
        <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8 lg:py-12">
          ...
          <div className="text-center mb-6 sm:mb-8 md:mb-12">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-500 max-w-3xl mx-auto px-4 sm:px-6 leading-relaxed">
              ...
              sharing your experiences from the 1994 genocide against the Tutsi
              in Rwanda.
            </p>
          </div>
